...
public class KafkaProducerConfig {
    ...
    @Value("${application.kafka-api-secret:foo}")
...
//    }
    ...
    @Bean
    public ProducerFactory<String, AvroFlashSaleEvent> flashSaleEventProducerFactory(Map<String, Object> kafkaProducerProperties) {
        return new DefaultKafkaProducerFactory<>(kafkaProducerProperties);
    }
